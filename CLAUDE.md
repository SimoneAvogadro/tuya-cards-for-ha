...
- `tuya_irrigation.irrigation_by_seconds(device_id | switch_entity, seconds)` — turn on, `asyncio.sleep(seconds)`, turn off. Cancellation-safe via per-switch task registry.
